...
const questions = [
  ...
  new Frage("Wer hat die Relativitätstheorie formuliert?", "Isaac Newton", "Albert Einstein", "Nikola Tesla", "Marie Curie", "b", 10, false),
  ...
  new Frage("Wer hat 'Faust' geschrieben?", "Friedrich Schiller", "Thomas Mann", "Johann Wolfgang von Goethe", "Bertolt Brecht", "c", 10, false),
  new Frage("Was ist der Sinus von 90 Grad?", "0", "1", "-1", "2", "b", 10, false),
  new Frage("Welches der folgenden Bauten ist keines der sieben Weltwunder der Antike?", "Pyramiden von Gizeh", "Freiheitsstatue", "O2", "N2", "b", 10, false),
  new Frage("Wer hat die Mona Lisa gemalt?", "Vincent van Gogh", "Pablo Picasso", "Leonardo da Vinci", "Claude Monet", "c", 10, false),
  new Frage("Wer war der erste Mensch im Weltraum?", "Herr Eschrich", "Yuri Gagarin", "Neil Armstrong", "Michael Collins", ["a", "b"], 10, false),
  new Frage("Wer war der erste Mensch auf dem Mond?", "Buzz Aldrin", "Mio Boege", "Neil Armstrong", "Michael Collins", "c", 10, false),
  new Frage("Was ist die Hauptstadt von Frankreich?", "Berlin", "London", "Madrid", "Paris", "d", 10, false),
  new Frage("Was ist der längste Fluss der Welt?", "Amazonas", "Nil", "Jangtse", "Mississippi", "b", 10, false),
  new Frage("Was ist der größte Planet in unserem Sonnensystem?", "Erde", "Mars", "Jupiter", "Venus", "c", 10, false),
  new Frage("Wer hat die Theorie der Evolution durch natürliche Selektion vorgeschlagen?", "Charles Darwin", "Gregor Mendel", "Louis Pasteur", "Alexander Fleming", "a", 10, false),
  new Frage("Was ist die Hauptstadt von Australien?", "Sydney", "Melbourne", "Canberra", "Perth", "c", 10, false),
