...
const pretime = 6000;
  ...
  const questions = [
    ...
    new Frage("Wer war der erste Mensch im Weltraum?", "Alexander Gerst", "Yuri Gagarin", "Neil Armstrong", "Herr Eschrich", "b", 5),

    new Frage("Wer ist der Imposter", "Tilman", "Christian", "Fabiola", "Mio", "c", 5),

    new Frage ("Wer kann die cleansten Liegestütze?", "Tilman", "Christian", "Fabiola", "David", ["c", "d"], 10),
    ...
    new Frage ('Wie viele Ecken hat ein Würfel?', '6', '8', '10', '12', 'b', 10),
    ...
    new Frage('Wie viele Kanten hat ein Würfel?', '6', '8', '10', '12', 'd', 10),
