...
const questions = [
  ...
  new Frage("Was ist die Quadratwurzel von 144?", "12", "14", "16", "18", "a", 15, false),
  new Frage("Wer hat die Relativitätstheorie formuliert?", "Isaac Newton", "Albert Einstein", "Nikola Tesla", "Marie Curie", "b", 15, false),
  new Frage("Was ist die Photosynthese?", "Ein Prozess, bei dem Pflanzen Licht in Energie umwandeln", "Ein Prozess, bei dem Tiere Licht in Energie umwandeln", "Ein Prozess, bei dem Protonen synthetisiert werden", "Eine chemische Reaktion,  bei der ein Proton von einem Reaktionspartner auf den anderen übertragen wird", "a", 15, false),
  ...
  new Frage("Welches der folgenden Bauten ist keines der sieben Weltwunder der Antike?", "Pyramiden von Gizeh", "Freiheitsstatue", "O2", "N2", "b", 15, false),
  new Frage("Wer hat die Mona Lisa gemalt?", "Vincent van Gogh", "Pablo Picasso", "Leonardo da Vinci", "Claude Monet", "c", 15, false),
  new Frage("Wer war der erste Mensch im Weltraum?", "Herr Eschrich", "Yuri Gagarin", "Neil Armstrong", "Michael Collins", ["a", "b"], 15, false),
  new Frage("Wer war der erste Mensch auf dem Mond?", "Buzz Aldrin", "Mio Boege", "Neil Armstrong", "Michael Collins", "c", 15, false),
  ...
  new Frage("Was ist die Hauptstadt von Australien?", "Sydney", "Melbourne", "Canberra", "Perth", "c", 15, false),
