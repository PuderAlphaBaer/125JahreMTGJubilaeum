...
const questions = [
  ...
  new Frage("Haben Sie schon unsere Festschrift gekauft?", "Ja", "Nein, aber ich kaufe gleich am Ende eine", "", "", ["a", "b"], 15, false),
  new Frage("Wie viele Fenster hat unser Hauptschulgebäude?", "420", "690", "134", "208", "d", 15, false),
  ...
  new Frage("Ende", "a", "a", "a", "a", "a", 0, false),
];
